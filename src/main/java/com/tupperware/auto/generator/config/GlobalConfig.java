 ...
 * the License.
 */
package com.tupperware.auto.generator.config;
...
public class GlobalConfig {
	...
	private String outputJavaDir = File.separator+"java";
	private String outputResDir = File.separator+"resources";
	...
	public String getOutputJavaDir() {
		return outputDir+File.separator+"java";
	}

	public String getOutputResDir() {
		return outputDir+File.separator+"resources";
	}
